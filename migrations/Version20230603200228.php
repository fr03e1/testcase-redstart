 ...
 */
final class Version20230603200228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_item (id INT NOT NULL, item_id INT NOT NULL, order_id INT NOT NULL, price NUMERIC(10, 2) NOT NULL, qty INT NOT NULL, PRIMARY KEY(id))');
