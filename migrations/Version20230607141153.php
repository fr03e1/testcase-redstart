 ...
 */
final class Version20230607141153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id INT NOT NULL, is_paid BOOLEAN NOT NULL, name VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, total INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE order_item (id INT NOT NULL, item_id INT DEFAULT NULL, order_id INT DEFAULT NULL, price NUMERIC(10, 2) NOT NULL, qty INT NOT NULL, PRIMARY KEY(id))');
